export const workflowEditorDefaultLocales = {
  "zh-CN": {
    baseSettings: "基础设置",
    formDesign: "表单设计",
    flowDesign: "流程设计",
    ...
    problemConfiguration: "备注",
    pleaseSelectProblemConfiguration: "请选择问题配置",
    judgementRule: "判定规则",
    pleaseSelectJudgementRule: "请选择判定规则",
    ruleName: "规则名称",
  ...
  "en-US": {
    ...
    loopParagraph: "Loop Paragraph",
    enableLoopParagraph: "Enable Loop Paragraph",
    enabled: "Enabled",
